...
internal class CustomMaterializer
{
    ...
    public static Expression Build(IEntityType entityType, ParameterExpression instanceParam)
    {
        ...
        return Block(
            ...
            IfThen(
                ...
                Block(
                    Condition(
                        NotEqual(entryVar, Default(entryVar.Type)),
                        MakeBinary(
                            ExpressionType.Assign,
                            instanceParam,
                            Convert(MakeMemberAccess(entryVar, entryVar.Type.GetProperty("Entity")!), classType)),
                    Block(
                        [shadowSnapshot1],
                        ...
                        IfThen(
                            ...
                            Call(
                                ...
                                Constant(entityType))),
                        IfThen(
                            NotEqual(Constant(entityType), Default(_entityClrType)),
                            Assign(
                                entryVar,
                                Call(
                                    queryContextParam,
